...
$route['students/add'] = 'Students/create';
...
$route['students/confirmdelete/(:any)']['DELETE'] = 'Students/delete/$1';

//$route['registration'] = 'Registration/index';
$route['registration']['GET'] = 'Registration/index';
$route['registration']['POST'] = 'Registration/index/register';